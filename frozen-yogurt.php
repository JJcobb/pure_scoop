...
<html lang="en">
  <head>
    ...
    <title>Frozen Yogurt - Pure Scoop</title>
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT id, name, description, category, sub_category, image_url
                FROM scoop_products WHERE sub_category LIKE '%Froyo%' ORDER BY name";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <p class="lead no-bottom">
                No one else makes frozen yogurt like this – a combination of tart fruits, fresh cultured buttermilk, organic yogurt, and cream. The result is tangier-than-expected froyo with creme fraiche creaminess. It's tart. It's punchy. It's unlike any frozen yogurt you've ever had. They're perfect on a cone, in a bowl with sliced fruit, or paired up with your favorite dessert.
              </p>
            </div>
        </div>
            ...
            <a href="sorbet.php">
              ...
              <div class="box-caption-still overlay-secondary">
                <div class="box-caption-content-still">
                  ...
                  <h3 class="box-caption-header secondary text-uppercase show-together">sorbet</h3>
