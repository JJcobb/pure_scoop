...
<html lang="en">
  <head>
    ...
    <title>Smoothies - Pure Scoop</title>
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT id, name, description, category, sub_category, image_url
                FROM scoop_products WHERE sub_category LIKE '%Smoothies%' ORDER BY name";
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
          ...
          <div class="carousel-caption">
            <h1 class="sm-mobile-text">Smoothies</h1>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <p class="lead no-bottom">
                Are you ready to try the most delicious fruit smoothie you’ve ever tasted? Blending real whole fruit and fruit juices, our smoothies were designed for the active lifestyle, delivering you much needed servings of fruit, vitamins, and proteins. 
              </p>
            </div>
        </div>
