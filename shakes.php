  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT id, name, description, category, sub_category, image_url
                FROM scoop_products WHERE sub_category LIKE '%Shakes%' ORDER BY name";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <p class="lead no-bottom">
                There are plain milkshakes, and then there are Shakes. What's the difference? Try one of ours and you won't have to ask! First we take our premium ice cream, then we blend it with our many quality toppings and mix-ins to create rich, thick and creamy, one-of-a-kind shakes. With so many possible options and flavor combinations to choose from, you won't know where to start!
              </p>
            </div>
        </div>
            ...
            <a href="smoothies.php">
              ...
              <div class="box-caption-still overlay-primary">
                <div class="box-caption-content-still">
                  ...
                  <h3 class="box-caption-header primary text-uppercase show-together">smoothies</h3>
            ...
            <a href="frappes.php">
              ...
              <div class="box-caption-still overlay-secondary">
                <div class="box-caption-content-still">
                  ...
                  <h3 class="box-caption-header secondary text-uppercase show-together">frappés</h3>
