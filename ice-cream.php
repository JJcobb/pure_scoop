...
<html lang="en">
  <head>
    ...
    <title>Ice Cream - Pure Scoop</title>
  ...
  <body>
    ...
    <?php
      ...
      $query = "SELECT id, name, description, category, sub_category, image_url
                FROM scoop_products WHERE sub_category LIKE '%Ice Cream%' ORDER BY name";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <p class="lead no-bottom">
                Our ice creams have a uniquely smooth texture and buttercream body, with bright flavor and clean finish (we don't use synthetic flavorings, dyes, or off-the-shelf mixes). We don't rely on a long list of stabilizers and emulsifiers; we prefer the more complex process of building texture and flavor without them.
              </p>
            </div>
        </div>
            ...
            <a href="frozen-yogurt.php">
              ...
              <div class="box-caption-still overlay-primary">
                <div class="box-caption-content-still">
                  ...
                  <h3 class="box-caption-header primary text-uppercase show-together">froyo</h3>
